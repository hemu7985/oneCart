 ...
 const removeList = async (id) => {
  try {
    let result = await axios.post(
      ...
      {}, // अगर कोई body data नहीं है तो खाली object
  ...
  fetchList()},[])
  return (
    <div className='w-full min-h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] text-white overflow-x-hidden relative'>
...
<span className='w-[35px] h-[30%] flex items-center font-semibold justify-center rounded-md md:hover:bg-red-300 md:hover:text-black cursor-pointer hover:text-red-300' onClick={()=>removeList(item._id)}>
  X
</span>
</div>
