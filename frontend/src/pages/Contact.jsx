...
<button className='px-[30px] sm:px-[20px] py-[10px] flex items-center justify-center text-white bg-transparent border active:bg-slate-600 rounded-md'>
  Explore Jobs
</button>
        </div>
      </div>
