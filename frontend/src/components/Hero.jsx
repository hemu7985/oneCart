  ...
  return (
    <div className='w-[40%] h-[100%] relative'>
      ...
      <div className='absolute md:top-[400px] lg:top-[500px] top-[160px] left-[10%] flex items-center justify-center gap-[10px]'>
        <FaCircle
          className={`w-[14px] ${heroCount === 0 ? "text-[#db6308]" : "text-[#fff]"}`}
          onClick={() => setHeroCount(0)}
        />
        <FaCircle
          className={`w-[14px] ${heroCount === 1 ? "text-[#db6308]" : "text-[#fff]"}`}
          onClick={() => setHeroCount(1)}
        />
        <FaCircle
          className={`w-[14px] ${heroCount === 2 ? "text-[#db6308]" : "text-[#fff]"}`}
          onClick={() => setHeroCount(2)}
        />
        <FaCircle
          className={`w-[14px] ${heroCount === 3 ? "text-[#db6308]" : "text-[#fff]"}`}
